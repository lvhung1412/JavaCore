...
public class Main {
    ...
    public  static LinkedHashMap<String, Double> layTenCaLamViec(Workbook workbook){
    ...
    public static LinkedHashMap<String, LinkedHashMap<String, Double>> layTienLuongCuaMoiCa(Workbook workbook){
...
//                    System.out.println("null");
    ...
    public static LinkedHashMap<String, LinkedHashMap<String, List<LinkedHashMap<String, Double>>>> laySoGioLamViec(Workbook workbook) {
...
//                    DecimalFormat df = new DecimalFormat("#");
    ...
    private static List<String> getNgayCong(Sheet sheet, FormulaEvaluator evaluator) {
        Row row= sheet.getRow(3);
    ...
    public static void printInformation(String filePath){
